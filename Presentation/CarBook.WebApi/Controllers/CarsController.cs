...
namespace CarBook.WebApi.Controllers
{
    ...
    public class CarsController : ControllerBase
    {
        ...
        public CarsController(CreateCarCommandHandler createCarCommandHandler, GetCarByIdQueryResultHandler getCarByIdQueryResultHandler, GetCarQueryHandler getCarQueryHandler, RemoveCarCommandHandler removeCarCommandHandler, UpdateCarCommandHandler updateCarCommandHandler, GetCarWithBrandQueryHandler getCarWithBrandQueryHandler)
        {
